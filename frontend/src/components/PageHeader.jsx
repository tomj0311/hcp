  ...
  return (
    <Stack direction="row" spacing={{ xs: 1, sm: 1.5 }} alignItems="center" sx={{ mb }}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'column' }}>
        <Typography variant="h5" sx={{ fontWeight: 700, fontSize: { xs: '1.6rem', sm: '1.9rem' } }}>
          {title}
        </Typography>
        {subtitle && (
          <Typography component="div" sx={{ mt: 0.25, opacity: 0.8, fontSize: { xs: '1rem', sm: '1.1rem' }, fontWeight: 900 }}>
            {subtitle}
          </Typography>
        )}
      </Box>
