...
export default function ProviderRegistration({ admin=false, token }){
  ...
  return (
    <Paper component="form" onSubmit={submit} sx={{p:{xs:3, sm:5}, maxWidth:1000, width:'100%', mx:'auto', mt:{xs:2, sm:4}, borderRadius:4, boxShadow:(t)=> t.palette.mode==='dark'? '0 10px 40px -12px rgba(0,0,0,0.65)':'0 12px 42px -14px rgba(30,50,70,0.18)'}}>
